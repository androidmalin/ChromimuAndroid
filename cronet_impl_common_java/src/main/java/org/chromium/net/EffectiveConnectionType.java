...
public @interface EffectiveConnectionType {
  ...
  int TYPE_UNKNOWN = 0;
  /**
   * Effective connection type reported when the Internet is unreachable, either because the device
   * does not have a connection or because the connection is too slow to be usable.
   */
  int TYPE_OFFLINE = 1;
  /**
